...
| `profile-about-experience` | About and Experience | implemented | Biography and timelines provide concise professional and personal context. | Full resume duplication; personal pursuits beyond one paragraph |
...
| `profile-beyond` | Beyond the Code | implemented | About page closes with an introduction and pursuit cards fed by a data file. | Dated activity log; dedicated route or nav entry |
