...
Spanish - Native
Skills
SQL Python BigQuery Google Cloud Platform (GCP)
Dataflow Apache Beam Pub/Sub Firestore
Airflow Prefect dbt Dataform
Terraform Pulumi Infrastructure as Code CI/CD
Docker Kubernetes Kafka PostgreSQL
Spark Flink SQLX Data Warehousing
ETL/ELT Dimensional Modeling Data Visualization Git
