...
export default function Contact() {
  // Initialize EmailJS
  useEffect(() => {
    emailjs.init('edLGcu2E2SFbqJgJN'); // Replace with your public key
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await emailjs.send(
        'service_skxvc2g',        // Replace with your EmailJS service ID
        'template_7t78vu2',       // Replace with your EmailJS template ID
        {
        ...
        'edLGcu2E2SFbqJgJN'    // Replace with your EmailJS public key
      );
